...
import 'package:searchjob/employer/bookmarks.dart';
import 'package:searchjob/employer/editProfile.dart';
           ...
           child: Column(
             ...
             Container(
               child: ListTile(
                 ...
                 trailing: Icon(Icons.navigate_next),
                 onTap: (){
                   Navigator.push(context,MaterialPageRoute(builder: (context) => reviews(str, user!.uid)));
                 },
               ),
             ),
             Container(
               child: ListTile(
                 ...
                 trailing: Icon(Icons.navigate_next),
                 onTap: (){
                   Navigator.push(context,MaterialPageRoute(builder: (context) => myEmployees(str, user!.uid)));
                 },
               ),
             ),
             Container(
