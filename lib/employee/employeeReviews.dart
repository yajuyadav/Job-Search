...
class employeeReviews extends StatefulWidget {
  String from, uid;
  employeeReviews(this.from, this.uid);
  @override
  _employeeReviewsState createState() => _employeeReviewsState();
}

class _employeeReviewsState extends State<employeeReviews> {
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              child: ListView(
                                ...
                                Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => viewEmployer(doc['employer'], emp['name'], emp['photo'])));
                                } },
